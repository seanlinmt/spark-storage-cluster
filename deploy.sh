...
scp $SSH_OPTS "corosync.conf" 192.168.177.11:/tmp/
scp $SSH_OPTS "nvme-safe-reboot.sh" 192.168.177.11:/tmp/
...
scp $SSH_OPTS "systemd/nvme-cluster-health.sh" 192.168.177.11:/tmp/
scp $SSH_OPTS "systemd/nvme-cluster-health.service" 192.168.177.11:/tmp/
scp $SSH_OPTS "systemd/nvme-cluster-health.timer" 192.168.177.11:/tmp/
scp $SSH_OPTS "systemd/corosync.service" 192.168.177.11:/tmp/
scp $SSH_OPTS "systemd/pacemaker.service" 192.168.177.11:/tmp/
...
scp $SSH_OPTS "corosync.conf" 192.168.177.12:/tmp/
scp $SSH_OPTS "nvme-safe-reboot.sh" 192.168.177.12:/tmp/
...
scp $SSH_OPTS "systemd/nvme-cluster-health.sh" 192.168.177.12:/tmp/
scp $SSH_OPTS "systemd/nvme-cluster-health.service" 192.168.177.12:/tmp/
scp $SSH_OPTS "systemd/nvme-cluster-health.timer" 192.168.177.12:/tmp/
scp $SSH_OPTS "systemd/corosync.service" 192.168.177.12:/tmp/
scp $SSH_OPTS "systemd/pacemaker.service" 192.168.177.12:/tmp/
