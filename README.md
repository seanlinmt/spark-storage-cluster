...
sequenceDiagram
    ...
    N1->>N1: losetup /dev/loop100 /shared_pool.img
    N2->>N2: losetup /dev/loop100 /shared_pool.img
    ...
    N1->>N1: Combine local loop100 + N2 remote into RAID0 (/dev/md0)
...
- **Loop Device:** e.g., `/dev/loop100` (Target node)
